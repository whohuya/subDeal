...
export const getRouterData = app => {
  const routerConfig = {
    ...
    "/user/signUp": {
      component: dynamicWrapper(app, ["auth", "login"], () =>
    ...
    "/dashboard": {
      component: dynamicWrapper(app, ["dashboard/dashboard"], () =>
    ...
    '/AddGoods':{
      component:dynamicWrapper(app,['dashboard/goods'],()=>
        import('../routes/Goods/AddGoods'))
    },
    '/GoodsList':{
      component:dynamicWrapper(app,[],()=>
      import('../routes/Goods/GoodsList'))
    },
    // users
    "/users": {
      component: dynamicWrapper(app, ["users/users"], () =>
        import("../routes/Users/Users")
      )
    },
    "/roles": {
      component: dynamicWrapper(app, ["users/roles"], () =>
        import("../routes/Users/Roles")
      )
    },
